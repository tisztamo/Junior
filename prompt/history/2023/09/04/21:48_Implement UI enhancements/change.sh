...
echo "3. Add a lightweight border to the right span in FilteredListItem and provide 2em width on each side of the border."
...
# Step 3: Adding a lightweight border to the right span in FilteredListItem and provide 2em width on each side of the border.
